            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1>FlashDeal Section</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="#">Flash Deals</a></li>
                                <li class="breadcrumb-item active" aria-current="page">All Flash Deals</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-md-6 col-sm-12 text-right hidden-xs">
                        <a href="{{ route('flash_deals.create')}}"
                           class="btn btn-rounded btn-info pull-right">{{__('Add New Flash Deal Products')}}</a>
            ...
            <div class="card">
                <div class="body mt-2">
                    <div class="panel-heading bord-btm clearfix pad-all h-100">
                        <h3 class="panel-title pull-left pad-no badge badge-primary p-2">{{__('Flash Deals')}}</h3>
                        ...
                        <table class="table header-border table-hover  spacing5">
                            ...
                            @foreach($flash_deals as $key => $flash_deal)
                                <tr>
                                    ...
                                    <td><img class="img-md" src="{{ asset($flash_deal->banner) }}" alt="banner">
                                    </td>
                                    ...
                                    <td>
                                        <div class="btn-group dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li>
                                                    <a href="{{route('flash_deals.edit', encrypt($flash_deal->id))}}">{{__('Edit')}}</a>
                                                </li>
                                                <li>
                                                    <a onclick="confirm_modal('{{route('flash_deals.destroy', $flash_deal->id)}}');">{{__('Delete')}}</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
