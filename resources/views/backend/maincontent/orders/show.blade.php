        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <label for=update_delivery_status"">{{__('Order Status')}}</label>
                        <select class="form-control demo-select2" data-minimum-results-for-search="Infinity"
                    ...
                    <div class="col-sm-6 text-xs-center">
                        ...
                        @if ($order->manual_payment && is_array(json_decode($order->manual_payment_data, true)))
                            ...
                            <a href="{{ asset(json_decode($order->manual_payment_data)->photo) }}" target="_blank"><img
                                        src="{{ asset(json_decode($order->manual_payment_data)->photo) }}" alt=""
                                        height="100"></a>
                        @endif
                    </div>
                    <div class="col-sm-6 text-xs-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($orderDetail->product != null)
                                            <a href="{{ route('products.admin', $orderDetail->product->slug) }}"
                                    ...
                                    <td>
                                        @if ($orderDetail->product != null)
                                            <strong><a href="{{ route('products.admin', $orderDetail->product->slug) }}"
