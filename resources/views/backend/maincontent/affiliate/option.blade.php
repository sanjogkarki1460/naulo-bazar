...
@section('title', isset($coupon) ? $coupon->title : 'Affiliate Option')
@push('styles')
    ...
    <div class="col-lg-6">
        <div class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('affiliate.option.store') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            @php
                                if(\App\Models\AffilateOption::where('type', 'user_registration_first_purchase')->first() != null){
                                    $percentage = \App\Models\AffilateOption::where('type', 'user_registration_first_purchase')->first()->percentage;
                                    $status = \App\Models\AffilateOption::where('type', 'user_registration_first_purchase')->first()->status;
                                }
                                else {
                                    $percentage = null;
                                }
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('affiliate.option.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            @php
                                if(\App\Models\AffilateOption::where('type', 'product_sharing')->first() != null && \App\Models\AffilateOption::where('type', 'product_sharing')->first()->details != null){
                                    $commission_product_sharing = json_decode(\App\Models\AffilateOption::where('type', 'product_sharing')->first()->details)->commission;
                                    $commission_type_product_sharing = json_decode(\App\Models\AffilateOption::where('type', 'product_sharing')->first()->details)->commission_type;
                                    $status = \App\Models\AffilateOption::where('type', 'product_sharing')->first()->status;
                                }
                                else {
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('affiliate.option.store') }}" method="POST">
                    @csrf
                    @php
                        if(\App\Models\AffilateOption::where('type', 'category_wise_affiliate')->first() != null){
                            $category_wise_affiliate_status = \App\Models\AffilateOption::where('type', 'category_wise_affiliate')->first()->status;
                        }
                    @endphp
                    <div class="form-group">
                        <div class="col-lg-4">
                    ...
                    @if (\App\Models\AffilateOption::where('type', 'category_wise_affiliate')->first() != null)
                        ...
                        @foreach (\App\Models\Category::all() as $key => $category)
                            @php
                                $found = false;
                            @endphp
                            @if(\App\Models\AffilateOption::where('type', 'category_wise_affiliate')->first()->details != null)
                                @foreach (json_decode(\App\Models\AffilateOption::where('type', 'category_wise_affiliate')->first()->details) as $key => $data)
