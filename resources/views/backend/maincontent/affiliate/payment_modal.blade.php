<form class="form-horizontal" action="{{ route('affiliate_user.payment_store') }}" method="POST"
    ...
    <div class="modal-body">
        ...
        @if ($affiliate_user->balance > 0)
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="number" min="0" step="0.01" name="amount" id="amount"
                           value="{{ $affiliate_user->balance }}" class="form-control" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="payment_method" id="payment_method" class="form-control demo-select2-placeholder"
                            required>
    ...
    <div class="modal-footer">
        <div class="panel-footer text-right">
            @if ($affiliate_user->balance > 0)
                <button class="btn btn-outline-secondary" type="submit">{{__('Pay')}}</button>
            @endif
