...
<div class="panel-heading">
    <h3 class="panel-title">Edit Your Cart Base Coupon</h3>
</div>
...
<div class="form-group">
    ...
    <div class="col-lg-9">
        <input type="number" min="0" step="0.01" name="min_buy" class="form-control" value="{{ $coupon_det->min_buy }}"
               required>
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    <label class="col-lg-3 control-label">Maximum Discount Amount</label>
    <div class="col-lg-9">
        <input type="number" min="0" step="0.01" placeholder="Maximum Discount Amount" name="max_discount"
               class="form-control" value="{{ $coupon_det->max_discount }}" required>
    </div>
</div>
<div class="form-group">
