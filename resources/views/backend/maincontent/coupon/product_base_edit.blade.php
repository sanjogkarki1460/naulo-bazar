                    ...
                    <select class="form-control subsubcategory_id demo-select2" name="subsubcategory_ids[]" required>
                        @foreach(\App\SubSubCategory::where('sub_category_id', $details->subcategory_id)->get() as $key => $subsubcategory)
                            <option value="{{$subsubcategory->id}}"
                                    @if ($details->subsubcategory_id == $subsubcategory->id)
                                    selected
...
<div class="form-group @if ($errors->has('vendor')) has-error @endif">
    ...
    <div class="col-sm-2 text-right">
        <label for="vendor" class="control-label">Vendors</label>
    </div>
    <div class="col-sm-10">
        ...
        <div id="demo-dp-range">
            <div class="input-daterange input-group" id="datepicker">
                <input type="text" class="form-control" name="start_date"
                       value="{{ date('m/d/Y', $coupon->start_date) }}" autocomplete="off">
...
<div class="form-group">
    ...
    <div class="col-lg-8">
        <input type="number" min="0" step="0.01" placeholder="{{__('Discount')}}" value="{{ $coupon->discount }}"
