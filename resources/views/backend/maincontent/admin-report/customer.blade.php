    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-6">
                <div class="card">
                    <div class="header">
                        <h2>Customer Order Cancelled</h2>
                    </div>
                    <div class="body text-center">
                        <canvas id="piechart2" style="width: 900px; height: 500px"></canvas>
                    </div>
                </div>
            </div>
        </div>
...
var myChart = new Chart(ctx, {
    ...
    data:
    {
        ...
        datasets: [{
            ...
            data: {!! $productStock->pluck('order_cancelled') !!},
            backgroundColor: {!! $productStock->pluck('color') !!},
            borderColor: [
                'rgba(255, 99, 132, 1)',
                'rgba(54, 162, 235, 1)',
