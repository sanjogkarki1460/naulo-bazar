@if(count($combinations[0]) > 0)
    <div class="text-center">
        <h5 class="badge badge-primary">Variant Details</h5>
    </div>
    <table class="table-bordered">
        ...
        <tr>
            ...
            <td class="text-center">
                <label for="" class="control-label">Cancel</label>
            </td>
        </tr>
        </thead>
        <tbody>
        ...
        @foreach ($combinations as $key => $combination)
            ...
            @if(strlen($str) > 0)
                <tr>
                    ...
                    <td>
                        <input type="file" name="image_{{$str}}[]" multiple>
                    </td>

                    <td>@if(!$loop->first)<a onclick="clearfix(this)" ><i class="fa fa-times"></i></a>@endif</td>
                </tr>
