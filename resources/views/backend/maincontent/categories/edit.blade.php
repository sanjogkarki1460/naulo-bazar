                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="digital" required
                                                ...
                                                <option value="0"
                                                        @if ($category->digital == '0') selected @endif>{{__('Physical')}}</option>
                                                <option value="1"
                                                        @if ($category->digital == '1') selected @endif>{{__('Digital')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <textarea class="form-control summernote" name="meta_description"
                                                      aria-label="Default">{{ $category->meta_description }}</textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="number" min="0" step="0.01" id="commision_rate"
                                                           name="commision_rate"
