                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="FACEBOOK_CLIENT_SECRET"
                                               ...
                                               placeholder="Facebook Client Secret" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-12 text-right">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="TWITTER_CLIENT_ID"
                                               value="{{ env('TWITTER_CLIENT_ID') }}" placeholder="Twitter Client ID"
                                               required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="TWITTER_CLIENT_SECRET"
                                               ...
                                               placeholder="Twitter Client Secret" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-12 text-right">
