            ...
            <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                <div class="section-title-1 clearfix">
                    ...
                    <ul class="inline-links float-right">
                        <li><a  class="active" style="background: #EB2329; border-color: #EB2329;">{{__('Top 20')}}</a></li>
                    </ul>
                </div>
                                ...
                                <div class="row no-gutters product-box-2 align-items-center">
                                    <div class="col-4">
                                        <div class="position-relative overflow-hidden h-100">
                                            <a href="{{ route('single.product', $product->slug) }}" class="d-block product-image h-100">
                                    ...
                                    <div class="col-8 border-left">
                                        <div class="p-3">
                                            <h2 class="product-title mb-0 p-0 text-truncate-2">
                                                <a href="{{ route('single.product', $product->slug) }}">{{ __($product->name) }}</a>
                                            </h2>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <div class="float-right">
                                                    <button class="add-to-cart btn" title="Add to Cart" onclick="showAddToCartModal({{ $product->id }})">
                                                        <i class="la la-shopping-cart" style="color: #fff;"></i>
                                                    </button>
                                                </div>
                                            </div>
