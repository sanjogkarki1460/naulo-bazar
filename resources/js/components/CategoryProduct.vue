            ...
            <div class="row">
                <div class="col-12 col-lg-3">
                    <div class="ps-shop--sidebar">
                        <div v-if="category.subcategories.length>0" class="sidebar__category">
                            
                            <div class="sidebar__title">Related Categories</div>
                            <ul class="menu--mobile">
                                <li v-for="subcategory in category.subcategories" :key="subcategory.id" class="daily-deals category-item"> <a :href="`/subcategory/${subcategory.slug}`">{{subcategory.name}}</a>
                                </li>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="form-check">
                                                ...
                                                <label for="sold0">Onestore<span>(55)</span></label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="form-check">
...
export default {
    props:['category','brands','searchKeyword'],
    data(){
        return{
            sort: 3,
            page:1,
    ...
    methods:{
        ...
        getProduct(page){
            axios.get(`/category/product/${this.category.id}/?page= ${page}`,{
                params:{
