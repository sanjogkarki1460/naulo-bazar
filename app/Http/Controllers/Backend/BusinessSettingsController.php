...
class BusinessSettingsController extends BackendController
{
    public function activation(Request $request)
    {
//        CoreComponentRepository::instantiateShopRepository();
        return view($this->_mainpages . 'business_settings.activation');
    }

    public function social_login(Request $request)
    {
//        CoreComponentRepository::instantiateShopRepository();
        return view($this->_mainpages . 'business_settings.social_login');
    }

    public function smtp_settings(Request $request)
    {
////        CoreComponentRepository::instantiateShopRepository();
        return view($this->_mainpages . 'business_settings.smtp_settings');
    }

    public function google_analytics(Request $request)
    {
//        CoreComponentRepository::instantiateShopRepository();
        return view($this->_mainpages . 'business_settings.google_analytics');
    }

    public function facebook_chat(Request $request)
    {
//        CoreComponentRepository::instantiateShopRepository();
        return view($this->_mainpages . 'business_settings.facebook_chat');
    }

    public function payment_method(Request $request)
    {
//        CoreComponentRepository::instantiateShopRepository();
        return view($this->_mainpages . 'business_settings.payment_method');
    }
    ...
    {
        return view($this->_mainpages . 'business_settings.seller_verification_form');
    }
    ...
    public function vendor_commission(Request $request)
    {
        ...
        return view($this->_mainpages . 'business_settings.vendor_commission', compact('business_settings'));
    }
    ...
    public function vendor_commission_update(Request $request)
    {
        ...
        return back()->with('status', 'Seller Commission Updated Successfully !!');
    }

    public function shipping_configuration(Request $request)
    {
        return view($this->_mainpages . 'shipping_configuration.index');
    }
