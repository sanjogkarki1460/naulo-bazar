...
class SellerWithdrawRequestController extends BackendController
{
    ...
    {
        $seller_withdraw_requests = SellerWithdrawRequest::where('user_id', Auth::user()->seller->id ?? 1)->paginate(9);
        return view($this->_mainpages.'sellers.seller_withdraw_requests.index', compact('seller_withdraw_requests'));
    }
