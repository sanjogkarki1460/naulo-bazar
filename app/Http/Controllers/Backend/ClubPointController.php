...
class ClubPointController extends BackendController
{
    ...
    public function update_product_point(Request $request, $id)
    {
        ...
        $product->earn_point = $request->point;
        $product->save();
        return redirect()->route('set_product_points')->with('Point has been updated successfully');
    }
    ...
    public function convert_rate_store(Request $request)
    {
        ...
        return redirect()->route('club_points.configs')->with('status','Point convert rate has been updated successfully');
    }
