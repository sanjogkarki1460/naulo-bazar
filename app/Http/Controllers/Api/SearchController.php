...
class SearchController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        return response()->json(['products' => $products, 'query' => $query, 'category_id' => $category_id, 'subcategory_id' => $subcategory_id, 'subsubcategory_id' => $subsubcategory_id, 'brand_id' => $brand_id, 'sort_by' => $sort_by, 'seller_id' => $seller_id,'min_price' =>$min_price, 'max_price' => $max_price, 'attributes' => $attributes, 'selected_attributes' => $selected_attributes, 'all_colors' => $all_colors, 'selected_color' => $selected_color]);
    }
